...
<style>
  ...
  /* ── layout utils ── */
  .cols2  { display:grid; grid-template-columns:1fr 1fr;    gap:.7rem; }
  .cols3  { display:grid; grid-template-columns:1fr 1fr 1fr; gap:.7rem; }
  .cols4  { display:grid; grid-template-columns:repeat(4,1fr); gap:.5rem; }
  .cols6  { display:grid; grid-template-columns:repeat(6,1fr); gap:.4rem; }
  ...
  .card-label { font-size:.5em; font-weight:700; text-transform:uppercase;
                letter-spacing:.08em; color:var(--gray2); margin-bottom:.15rem; }
  .card-value { font-size:1.5em; font-weight:800; line-height:1; }
  .card-sub   { font-size:.5em; color:var(--gray2); margin-top:.2rem; }
  ...
  .row-card .num {
    ...
    font-weight:800; font-size:.8em; color:var(--bg); flex-shrink:0;
  }
  .row-card .timing {
    font-size:.55em; font-weight:700; padding:.2rem .6rem;
  ...
  .def-rule {
    ...
    padding:.35rem .8rem; margin-bottom:.3rem;
    border-left:3px solid;
  }
  .def-rule .rule-label { font-size:.55em; font-weight:700;
    text-transform:uppercase; letter-spacing:.08em; }
  .def-rule .rule-text  { font-size:.65em; color:var(--gray1); margin-top:.08rem; }

  /* ── timeline row ── */
  .timeline-row {
    display:grid;
    grid-template-columns: 2.4rem 5rem 1fr 1fr;
    align-items:center; gap:.6rem;
    background:var(--surface); border-radius:6px;
    padding:.35rem .7rem; margin-bottom:.25rem;
  ...
  .slide-header { margin-bottom:.6rem; }
  .slide-header h2 { font-size:1.1em; font-weight:800; margin:.2rem 0 .05rem; }
  .slide-header .sub { font-size:.6em; color:var(--gray2); }
  ...
  .feat-row {
    ...
    background:var(--surface); border-radius:6px;
    padding:.35rem .7rem; margin-bottom:.28rem; overflow:hidden;
  }
  .feat-row .bar { width:3px; height:1.6rem; border-radius:2px; }
  .feat-title  { font-size:.68em; font-weight:700; color:var(--white); }
  .feat-desc   { font-size:.55em; color:var(--gray2); }
  ...
  /* ── slide numbering — bottom left to avoid overlap with controls ── */
  .reveal .slide-number {
    background: transparent; color: var(--gray2);
    font-size: .6em; bottom: .6rem; left: 1rem; right: auto;
  }
  /* ── controls — push up so they don't overlap ── */
  .reveal .controls { bottom: 1.4rem; right: .8rem; }
  ...
  .reveal p, .reveal li { font-size:.75em; line-height:1.4; }
...
<section>
  ...
  <div style="display:grid;gap:.22rem;">
    <div class="timeline-row" style="border-color:var(--gray2);padding:.28rem .6rem;">
      <span class="badge" style="background:var(--gray2);font-size:.5em;">D0</span>
      <span style="font-size:.58em;color:var(--gray2);">2021 – Q1 2023</span>
      <span style="font-size:.65em;font-weight:700;color:var(--white);">Logo churn puro</span>
      <span style="font-size:.58em;color:var(--gray1);">Misura clienti persi. Non cattura la perdita di fatturato.</span>
    </div>
    <div class="timeline-row" style="border-color:var(--orange);padding:.28rem .6rem;">
      <span class="badge" style="background:var(--orange);font-size:.5em;">D1</span>
      <span style="font-size:.58em;color:var(--gray2);">Q2 – Q4 2023</span>
      <span style="font-size:.65em;font-weight:700;color:var(--white);">Logo + downgrade</span>
      <span style="font-size:.58em;color:var(--gray1);">Cambiato con il nuovo CFO. Include contrazioni ma senza soglia chiara.</span>
    </div>
    <div class="timeline-row" style="border-color:var(--cyan);padding:.28rem .6rem;">
      <span class="badge" style="background:var(--cyan);font-size:.5em;">D2</span>
      <span style="font-size:.58em;color:var(--gray2);">2024 – Q1 2025</span>
      <span style="font-size:.65em;font-weight:700;color:var(--white);">nMRR grezzo</span>
      <span style="font-size:.58em;color:var(--gray1);">Migliora la misura revenue ma manca la normalizzazione annuali ÷ 12.</span>
    </div>
    <div class="timeline-row" style="border-color:var(--red);background:#2a1015;padding:.28rem .6rem;">
      <span class="badge" style="background:var(--red);font-size:.5em;">D3</span>
      <span style="font-size:.58em;color:var(--gray2);">Q2 2025</span>
      <span style="font-size:.65em;font-weight:700;color:var(--red);">nMRR + duplicati CRM</span>
      <span style="font-size:.58em;color:var(--gray1);">BUG: 340 eventi duplicati — rate da 2.1% a 5.8% (+3.7pp falsi).</span>
    </div>
    <div class="timeline-row" style="border-color:var(--green);background:var(--surface2);padding:.28rem .6rem;">
      <span class="badge" style="background:var(--green);font-size:.5em;">D4</span>
      <span style="font-size:.58em;color:var(--gray2);">v1.0 canonica</span>
      <span style="font-size:.65em;font-weight:700;color:var(--green);">nMRR normalizzato · clean</span>
      <span style="font-size:.58em;color:var(--green);">Definizione approvata. Retroattiva su 5 anni. ✓</span>
    </div>
  </div>

  <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:.5rem;margin-top:.4rem;">
    <div class="card green" style="padding:.4rem .7rem;">
      <div class="card-label">Delta medio storico vs board</div>
      <div class="card-value" style="color:var(--green);font-size:1.2em;">+0.4pp</div>
      <div class="card-sub">Board ha sotto-stimato sistematicamente</div>
    </div>
    <div class="card red" style="padding:.4rem .7rem;">
      <div class="card-label">Picco anomalo Q2 2025</div>
      <div class="card-value" style="color:var(--red);font-size:1.2em;">+3.7pp</div>
      <div class="card-sub">Board: 5.8% · Canonical: 2.1% · Bug duplicati</div>
    </div>
    <div class="card cyan" style="padding:.4rem .7rem;">
      <div class="card-label">Trimestri riconciliati</div>
      <div class="card-value" style="color:var(--cyan);font-size:1.2em;">20</div>
      <div class="card-sub">Q1 2021 → Q4 2025 · D4 vince 15/15</div>
    </div>
  </div>
</section>
